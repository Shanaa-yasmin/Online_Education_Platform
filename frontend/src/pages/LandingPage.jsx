    ...
    <div className="landing">
      ...
      <footer className="footer">
        <div className="footer-top">
          <div>
            <div className="f-logo"><div className="f-logo-mark"><i className="ti ti-trending-up" /></div><span className="f-logo-text">Edu<span>Path</span></span></div>
          ...
          <div><p className="f-col-h">Platform</p><div className="f-links">{['Explore Courses','Become a Mentor','Partnerships','Our Impact','Enterprise'].map(l=><a key={l} className="f-link" href="#">{l}</a>)}</div></div>
          <div><p className="f-col-h">Company</p><div className="f-links">{['About Us','Careers','Blog','Press','Contact'].map(l=><a key={l} className="f-link" href="#">{l}</a>)}</div></div>
          <div><p className="f-col-h">Support</p><div className="f-links">{['Help Center','Student Support','Refund Policy','Privacy Policy','Terms of Use'].map(l=><a key={l} className="f-link" href="#">{l}</a>)}</div></div>
        </div>
        <div className="footer-bottom">
          <p className="f-copy">© 2026 EduPath Inc. All rights reserved.</p>
          <div className="f-legal">
            {['Privacy','Terms','Cookies','Sitemap'].map(l=><a key={l} className="f-leg-link" href="#">{l}</a>)}
          </div>
        </div>
      </footer>
